...
class CometChatBanMembers extends React.Component {
    ...
    render() {
        ...
        const noRecordsFound = (
            <tr><td colSpan="3">No se encontraron miembros expulsados</td></tr>
        );
                ...
                <div css={modalWrapperStyle(this.props)}>
                    ...
                    <div css={modalBodyStyle()}>
                        <table css={modalTableStyle(this.props)}>
                            <caption css={tableCaptionStyle()}>Participantes expulsados</caption>
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th css={roleColumnStyle()}>Tipo</th>
                                    <th css={actionColumnStyle()}>Admitir</th>
                                </tr>
                            </thead>
