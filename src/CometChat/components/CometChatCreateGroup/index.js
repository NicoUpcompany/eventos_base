...
class CometChatCreateGroup extends React.Component {
    ...
    validate = () => {
        ...
        if(!groupName) {
            this.setState({error: "El nombre del grupo no puede quedar en blanco."})
            return false;
        }
        ...
        if(groupType === "protected") {
            ...
            if(!password.trim().length) {
                this.setState({error: "La contraseña del grupo no puede quedar en blanco."})
                return false;
            }
        }
        return true;
                ...
                <div css={modalWrapperStyle(this.props)}>
                    ...
                    <div css={modalBodyStyle()}>
                        ...
                        <table css={modalTableStyle(this.props)}>
                            <caption css={tableCaptionStyle()}>Crear grupo</caption>
                            ...
                            <tfoot css={tableFootStyle(this.props)}>
                                <tr>
                                    <td><button tabIndex="4" onClick={this.createGroup}>Crear</button></td>
                                </tr>
                            </tfoot>
                        </table>
