    ...
    render() {
        ...
        let viewMembersBtn = (
            <div css={contentItemStyle()}>
                <div css={itemLinkStyle(this.props, 0)} onClick={() => this.clickHandler("viewmember", true)}>Ver miembros</div>                                           
            </div>
        );
        ...
        if(this.props.item.scope === CometChat.GROUP_MEMBER_SCOPE.ADMIN) {
            addMembersBtn = (
                <div css={contentItemStyle()}>
                    <div css={itemLinkStyle(this.props, 0)} onClick={() => this.clickHandler("addmember", true)}>Añadir miembros</div>                                           
                </div>
            );

            deleteGroupBtn = (
                <div css={contentItemStyle()}>
                    <span css={itemLinkStyle(this.props, 1)} className="item__link link--delete" onClick={this.deleteGroup}>Eliminar y salir</span>
                </div>
            );
        }
        ...
        if(this.props.item.scope !== CometChat.GROUP_MEMBER_SCOPE.PARTICIPANT) {
            bannedMembersBtn = (
                <div css={contentItemStyle()}>
                    <div css={itemLinkStyle(this.props, 0)} onClick={() => this.clickHandler("banmember", true)}>Miembros prohibidos</div>                                           
                </div>
            );
        }
        ...
        let leaveGroupBtn = (
            <div css={contentItemStyle()}>
                <span css={itemLinkStyle(this.props, 0)} onClick={this.leaveGroup}>Salir del grupo</span>
            </div>
        );
        ...
        let members = (
            <div css={sectionStyle()}>
                <h6 css={sectionHeaderStyle(this.props)}>Miembros</h6>
        ...
        let options = (
            <div css={sectionStyle()}>
                <h6 css={sectionHeaderStyle(this.props)}>Opciones</h6>
                <div css={sectionContentStyle()}>
                    {leaveGroupBtn}
                    {deleteGroupBtn}
                </div>
            ...
            <div css={detailStyle(this.props)}>
                ...
                value={{
                    ...
                    <div css={headerStyle(this.props)}>
                        ...
                        <h4 css={headerTitleStyle()}>Ajustes</h4>
                    </div>
