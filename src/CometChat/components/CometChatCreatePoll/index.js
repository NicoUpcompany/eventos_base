...
class CometChatCreatePoll extends React.Component {
    ...
    createPoll = () => {
        ...
        if (question.length === 0) {
            ...
            this.setState({ error: "La opción no puede estar en blanco." })
            return false;
        }
                ...
                <div css={modalWrapperStyle(this.props)}>
                    ...
                    <div css={modalBodyStyle()}>
                        <table css={modalTableStyle(this.props)}>
                            <caption css={tableCaptionStyle()}>Crear encuesta</caption>
                            <tbody css={tableBodyStyle()}>
                                ...
                                <tr>
                                    ...
                                    <td colSpan="2">
                                        <input type="text" autoFocus tabIndex="1" placeholder="Ingrese su pregunta" ref={this.questionRef} />
                                    </td>
                                </tr>
                                <tr>
                                    <td><label>Options</label></td>
                                    <td colSpan="2">
                                        <input type="text" placeholder="Ingrese su opción" ref={this.optionOneRef} />
                                    </td>
                                </tr>
                                <tr ref={this.optionRef}>
                                    <td>&nbsp;</td>
                                    <td colSpan="2">
                                        <input type="text" placeholder="Ingrese su opción" ref={this.optionTwoRef} />
                                    </td>
                                </tr>
                                {pollOptionView}
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><label>Agregar nueva opción</label></td>
                            ...
                            <tfoot css={tableFootStyle(this.props)}>
                                <tr>
                                    <td colSpan="2"><button onClick={this.createPoll}>Crear</button></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
