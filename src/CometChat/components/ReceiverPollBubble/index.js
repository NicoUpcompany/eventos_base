                ...
                <div css={messageWrapperStyle()}>
                    ...
                    <div css={messageDetailStyle()}>
                        ...
                        <div css={messageInfoWrapperStyle()}>
                            <span css={messageTimestampStyle(this.props)}>{new Date(this.props.message.sentAt * 1000).toLocaleTimeString('es-CL', { hour: 'numeric', minute: 'numeric', hour12: true })}</span>
                        </div>
                    </div>
                </div>
            </div>
