...
class MemberView extends React.Component {
    ...
    constructor(props) {
        ...
        this.roles = {}
        this.roles[CometChat.GROUP_MEMBER_SCOPE.ADMIN] = "Administrador";
        this.roles[CometChat.GROUP_MEMBER_SCOPE.MODERATOR] = "Moderador";
        this.roles[CometChat.GROUP_MEMBER_SCOPE.PARTICIPANT] = "Participante";
    }
    ...
    render() {
        ...
        if(this.props.item.owner === this.props.member.uid) {
            scope = (<span css={roleStyle()}>{"Administrador"}</span>);
            changescope = scope;
            ban = null;
            kick = null;
        }
